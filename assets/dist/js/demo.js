...
(function ($) {
  ...
  $(".tabla_usuario").on("click", ".btn-editar", function() {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            $("#idUsuarioE").val(respuesta["id"]);
            $("#nombre_usuarioE").val(respuesta["nombre"]);
            $("#correo_usuarioE").val(respuesta["email"]);
            $("#password_usuarioE").val(respuesta["password"]);
            $("#passworActualE").val(respuesta["password"]);
        }
    });
  });
